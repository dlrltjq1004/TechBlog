...
public class DeleteAriticleService {

	private ArticleDao articleDao = new ArticleDao();
	private ArticleContentDao contentDao = new ArticleContentDao();
	private static DeleteAriticleService instance = new DeleteAriticleService();
	
	public static DeleteAriticleService getInstance() {
		return instance;
	}
	
	private DeleteAriticleService() {}
